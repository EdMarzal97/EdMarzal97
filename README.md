...
From designing the databases and the UI following the best practices for guarantee the best user experience posible (UX) to deploying and managing the app using Cloud technologies like Amazon web services. I'm a software engineer specialized in  Typescript and Javascript with more than 5 years of professional experience in the market with experience in end-end development 💻. 

I count on experience working with agile methodologies (SCRUM), Cloud services ( AWS ), and developer tools and technologies like Figma, Jira, Docker, Kafka, Graphql, Redux, Jest, Playwright etc...

🚀 Technologies : Javascript, Typescript, React, Next.js, Nest.js, Node.js
