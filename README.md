...
From designing the databases and the UI following the best practices for guarantee the best user experience posible (UX) to deploying and managing the app using Cloud technologies like Amazon web services. I'm a software engineer specialized in  Python and Javascript with more than 5 years of professional experience in the market with experience in end-end development 💻. 

I count on experience working with agile methodologies (SCRUM), Cloud services ( AWS, Azure ), and developer tools and technologies like Figma, Jira, Docker, Kafka, Graphql, Redux, Pytest, Jest, Playwright etc...

🚀 Technologies : Javascript, Typescript, Python, Django, Flask, FastAPI, React, Next.js, Nest.js, Node.js.
